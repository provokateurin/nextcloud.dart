...
For an example checkout the [example](https://github.com/provokateurin/nextcloud.dart/blob/main/example/example.dart).  
...
The nextcloud package was developed in a monorepo for a long time, but since it has been a lot more stable we moved it to a separate repo without all the history.
All previous history can be browsed from here: https://github.com/nextcloud/neon/tree/dc0c23a221f90bc76651b8e1905a531a8a61cd61/packages/nextcloud
